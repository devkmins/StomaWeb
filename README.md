...
- [StomaWeb](#stomaweb)
  ...
  - [설계](#설계)
    ...
    - [함수](#함수)
      ...
      - [시장 페이지 - 뉴스 페이지 모바일](#시장-페이지---뉴스-페이지-모바일)
...
| 관심 종목 페이지                                                                                                                              |
| --------------------------------------------------------------------------------------------------------------------------------------------- |
| <img width="50%" alt="관심 종목 페이지 기획" src="https://github.com/devkmins/StomaWeb/assets/59950909/55c039dd-18c5-4408-b11e-dcef95429610"> |
...
| 관심 종목 페이지                                                                                                                                       |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <img width="50%" alt="관심 종목 페이지 요구사항 정리" src="https://github.com/devkmins/StomaWeb/assets/59950909/6eb38254-58db-4976-8466-8481a8841b4d"> |
...
| initializeIndexedDB                                                                                                                                                      | createCategoryStores                                                                                                                                                      | addToWatchlist                                                                                                                                                      | removeToWatchlist                                                                                                                                                      | getWatchlist                                                                                                                                                      |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <img width="400" alt="관심 종목 페이지의 initializeIndexedDB 함수 설계" src="https://github.com/devkmins/StomaWeb/assets/59950909/7f0fe651-1d63-491e-80d2-762d448ff949"> | <img width="400" alt="관심 종목 페이지의 createCategoryStores 함수 설계" src="https://github.com/devkmins/StomaWeb/assets/59950909/3b66aac5-8b67-4128-91b8-68379f84d345"> | <img width="400" alt="관심 종목 페이지의 addToWatchlist 함수 설계" src="https://github.com/devkmins/StomaWeb/assets/59950909/504124e3-d7ae-4e45-9fe9-20e1b269f528"> | <img width="400" alt="관심 종목 페이지의 removeToWatchlist 함수 설계" src="https://github.com/devkmins/StomaWeb/assets/59950909/868996a8-b512-43e6-9ea2-3b745c8c1d2d"> | <img width="400" alt="관심 종목 페이지의 getWatchlist 함수 설계" src="https://github.com/devkmins/StomaWeb/assets/59950909/6a43071d-61d5-4548-aca3-f87e7c176069"> |

| toggleSettingsIcon                                                                                                                                                      | fetchMarketData                                                                                                                                                      | calculateAssetChange                                                                                                                                                      | calculateCumulativeVolumeChanges                                                                                                                                                      |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <img width="400" alt="관심 종목 페이지의 toggleSettingsIcon 함수 설계" src="https://github.com/devkmins/StomaWeb/assets/59950909/057d1f91-d505-42a0-bd12-4bb662c37658"> | <img width="400" alt="관심 종목 페이지의 fetchMarketData 함수 설계" src="https://github.com/devkmins/StomaWeb/assets/59950909/c35c0946-41ee-4343-9f92-805b15854fbe"> | <img width="400" alt="관심 종목 페이지의 calculateAssetChange 함수 설계" src="https://github.com/devkmins/StomaWeb/assets/59950909/f7344839-baf4-49b2-b879-276526c8493c"> | <img width="400" alt="관심 종목 페이지의 calculateCumulativeVolumeChanges 함수 설계" src="https://github.com/devkmins/StomaWeb/assets/59950909/d1dcdb87-8b5d-4abb-acee-abef6b5b05a8"> |
...
| 상태                         | 데이터 타입   |
| ---------------------------- | ------------- |
| 뉴스 데이터 전역 상태        | Array[Object] |
| 암호화폐 데이터 전역 상태    | Array[Object] |
| 외환 데이터 전역 상태        | Array[Object] |
| ETF 데이터 전역 상태         | Array[Object] |
| 선물 데이터 전역 상태        | Array[Object] |
| 무츄얼 펀드 데이터 전역 상태 | Array[Object] |
